...
REACTOR_MOD_002 | Reactor.Modifier | Info | SetModifierAvailableAnalyzer - .Set assigns a property that has a first-class fluent modifier; receiver-gated for Padding/CornerRadius/BorderThickness/BorderBrush/Background, which the reconciler only applies to specific control types
