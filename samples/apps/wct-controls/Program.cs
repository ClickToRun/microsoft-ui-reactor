...
internal sealed class PropertySizerPage : Component
{
    public override Element Render()
    {
        ...
        // mount, so the property-changed callback is registered exactly once.
        return Gallery.Page(
            "PropertySizer",
            ...
            HStack(0,
                ...
                PropertySizer(binding: width, minimum: 120, maximum: 360)
                    .Height(160)
                    .OnMount(fe => ((CommunityToolkit.WinUI.Controls.PropertySizer)fe).RegisterPropertyChangedCallback(
